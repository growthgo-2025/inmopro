...
# Unset conflicting shell env vars so .env file values are used
unset DATABASE_URL NEXT_PUBLIC_SUPABASE_URL NEXT_PUBLIC_SUPABASE_ANON_KEY SUPABASE_SERVICE_ROLE_KEY SUPABASE_STORAGE_BUCKET ADMIN_PASSWORD ADMIN_SESSION_SECRET 2>/dev/null || true
